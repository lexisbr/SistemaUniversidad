...
public class VerNotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, 50));
    ...
    public void cargarTabla() {
        ...
        for (int i = 0; i < listaAsignaciones.size(); i++)
        {
            ...
            int total = asignacion.getZona()+asignacion.getFinal_test();
            String data[] =
            {
                curso.getName(),String.valueOf(asignacion.getZona()), String.valueOf(asignacion.getFinal_test()),String.valueOf(total)
            };
