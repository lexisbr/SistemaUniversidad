...
public class AgregarCatedratico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Agregar Catedratico");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
                if (Manejador.addCatedratico(id, name, address))
                {
                    JOptionPane.showMessageDialog(this, "Se ha agregado al catedratico: " + id + " correctamente. ");
                    idTxt.setText("");
                    nombreTxt.setText("");
                ...
                {
                    JOptionPane.showMessageDialog(this, "No se ha agregado el catedratico: " + id + " porque este id ya existe. ","Error",JOptionPane.ERROR_MESSAGE);
                }
            } else
            {
